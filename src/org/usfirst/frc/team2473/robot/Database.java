...
public class Database{
	...
	public enum Value {
		...
		GYRO_POSITION, GYRO_VELOCITY, LEFT_ENCODER_POSITION, RIGHT_ENCODER_POSITION, LEFT_ENCODER_VELOCITY, BREAK_BEAM, WHEEL_TWIST, THROTTLE_VALUE, CV_DISTANCE, CV_ANGLE_A, CV_BEARING, CV_L_OR_R, CV_TIME_STAMP, CV_PI_CONNECTED, SWITCH_ONE, SWITCH_TWO, SWITCH_THREE, SWITCH_FOUR, ;// add
																																	// button
	}
